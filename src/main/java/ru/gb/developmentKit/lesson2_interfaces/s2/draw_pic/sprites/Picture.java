package ru.gb.developmentKit.lesson2_interfaces.s2.draw_pic.sprites;




import ru.gb.developmentKit.lesson2_interfaces.s2.common.MainCanvas;
import ru.gb.developmentKit.lesson2_interfaces.s2.common.Sprite;
...
public class Picture extends Sprite {
    ...
    public Picture(int x, int y){
        ...
        halfWidth = 62;
        try {
            image = ImageIO.read(new File("src/main/java/ru/gb/developmentKit/lesson2_interfaces/s2/draw_pic/resource/picachu.png"));
        } catch (IOException e) {
