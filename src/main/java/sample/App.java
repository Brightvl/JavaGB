...
import other_class.Decorator;
import other_class.OtherClass;

/**
 * проект создается через структуру проекта -> артефакты -> + JAR -> далее нужно выбрать путь к точке входа и все
 *     1 вариант запуска
 *     Построение и запуск архива .jar
 * cd ..\JavaCore\out\artifacts\JavaCore_jar
